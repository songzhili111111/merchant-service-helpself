...
<script type="text/javascript" src="files/jquery.json-2.4.js"></script>
<script type="text/javascript">
	...
	function lottery() {
		...
		if(num == 0){
		 ...
		 var data ={'code':'code','version':'version','data':[{
			  'briberyMoneyName':'name','briberyMoneyType':'type','briberyMoneyExplain':'这个是谁呢'
			  ,'startTime':'endTime','endTime':'endTime'
			  ,'briberyMoneyRule':[{'start':'1','end':'5','chance':'0.5'},
			   {'start':'6','end':'10','chance':'0.3'},{'start':'11','end':'15','chance':'0.1'}]
		      ,'expandParam':'expandParam','curragePage':'1','pageSize':'10'
		  }]};
				$.ajax({
					type : 'POST',
					url : 'briberyMoney/list',
					dataType : 'json',
